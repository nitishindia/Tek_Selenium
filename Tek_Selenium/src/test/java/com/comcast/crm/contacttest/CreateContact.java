...
public class CreateContact {
	...
	public static void main(String[] args) throws IOException {
		...
		// property file                             // (./) means it will go to parent directory means project name
		FileInputStream fis = new FileInputStream("./configAppData/CommonData_Vtiger.proreties"); // Instant of relativepath will use absolutepath 
		...
		// excel file
		FileInputStream fis1 = new FileInputStream("./testdata/TestDataAA4.xlsx");
